...
$ cd $GOPATH/src/github.com/GM-Publicchain/gm/plugin/dapp/calculator
//显示生成目录结构
$ tree -d
.
├── cmd //官方ci目录
...
import (
	...
	ptypes "github.com/GM-Publicchain/gm/plugin/dapp/calculator/types/calculator"
)
```
...
```go
 import (
 	_ "github.com/GM-Publicchain/gm/plugin/dapp/calculator" //auto gen
 ```

##### 编译
>直接通过官方makefile文件
```
$ cd $GOPATH/src/github.com/GM-Publicchain/gm && make
```
