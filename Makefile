...
SRC_CLI := github.com/GM-Publicchain/gm/cli
APP := build/chain33
...
BUILD_FLAGS = -ldflags "-X github.com/GM-Publicchain/gm/vendor/github.com/33cn/chain33/common/version.GitCommit=`git rev-parse --short=8 HEAD`"
...
update:
	...
	./tool import --path "plugin" --packname "github.com/GM-Publicchain/gm/plugin" --conf ""
...
addupstream:
	git remote add upstream https://github.com/GM-Publicchain/gm.git
	git remote -v
